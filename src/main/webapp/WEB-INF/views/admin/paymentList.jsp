...
<%--                                    <option value="title"<c:if test="${type eq 'author'}"> selected="selected"</c:if>>고객아이디</option>--%>
<%--                                    <option value="name"<c:if test="${type eq 'sno'}"> selected="selected"</c:if>>수강번호</option>--%>
<%--                                </select>--%>
<%--                            </div>--%>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${paymentList }" var="pay" varStatus="status">
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="${path }/lecture/getLecture.do?no=${lecture.lno }">${lecture.title }</a></td>
